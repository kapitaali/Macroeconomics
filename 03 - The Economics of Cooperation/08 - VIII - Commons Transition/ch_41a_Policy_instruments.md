...
*Chapter 41b addresses a dimension the current policy portfolio presupposes but does not itself provide: the predistributive foundations of the cooperative labour market. If the Shapley value allocates cooperative surplus fairly, it does so among players who are already participating in the cooperative game. The employment guarantee, working time reduction, and the Shapley extension to care labour establish who participates, on what terms — the institutional architecture without which the policy instruments of this chapter would be correcting outcomes that the primary distribution immediately regenerates.*

*Chapter 41c then addresses the governance question that precedes even the policy portfolio: who decides what the cooperative-regenerative economy is trying to achieve, how those objectives are measured, and how cooperative institutions are held accountable to them? The Sustainable and Inclusive Wellbeing accounting framework, the citizens' assembly as a deliberative convergence mechanism, and the Democratic Accountability Loop provide the steering architecture that gives the transition democratic legitimacy alongside analytical rigour.*

*Chapter 42 closes Part VIII with the theory and practice of social experimentation — the multi-armed bandit problem applied to cooperative-regenerative policy design, the Preston Model as a worked case, and Barcelona en Comú as the empirical test of municipalist cooperative economics. Together, the five chapters of Part VIII span transition theory, policy instruments, labour foundations, democratic governance, and experimental learning — the complete architecture for navigating from here to there.*
